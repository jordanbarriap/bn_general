...
public class Network extends Wrapper implements Cloneable {
    // Bayesian network algoritm types
    public static class BayesianAlgorithmType {
        public static final int LAURITZEN            = 0;
        public static final int HENRION              = 1;
        public static final int PEARL                = 2;
        public static final int L_SAMPLING           = 3;
        public static final int SELF_IMPORTANCE      = 4;
        public static final int HEURISTIC_IMPORTANCE = 5;
        public static final int BACK_SAMPLING        = 6;
        public static final int AIS_SAMPLING         = 7;
        public static final int EPIS_SAMPLING        = 8;
        public static final int LBP                  = 9;

        @Deprecated
        public static final int Lauritzen = LAURITZEN;
        @Deprecated
        public static final int Henrion = HENRION;
        @Deprecated
        public static final int Pearl = PEARL;
        @Deprecated
        public static final int LSampling = L_SAMPLING;
        @Deprecated
        public static final int SelfImportance = SELF_IMPORTANCE;
        @Deprecated
        public static final int HeuristicImportance = HEURISTIC_IMPORTANCE;
        @Deprecated
        public static final int BackSampling = BACK_SAMPLING;
        @Deprecated
        public static final int AisSampling = AIS_SAMPLING;
        @Deprecated
        public static final int EpisSampling = EPIS_SAMPLING;
    }
	
    // Influence diagram algoritm types
    public static class InfluenceDiagramAlgorithmType {
        public static final int POLICY_EVALUATION = 0;
        public static final int FIND_BEST_POLICY = 1;

        @Deprecated
        public static final int PolicyEvaluation = POLICY_EVALUATION;
        @Deprecated
        public static final int FindBestPolicy = FIND_BEST_POLICY;
    }
	
    // Node types
    public static class NodeType {
        public static final int CPT         = 18;
        public static final int TRUTH_TABLE = 20;
        public static final int DECISION    = 17;
        public static final int UTILITY     = 8;
        public static final int MAU         = 520;
        public static final int NOISY_MAX   = 146;
        public static final int NOISY_ADDER = 274;
        public static final int EQUATION    = 4;
        public static final int DEMORGAN    = 82;

        @Deprecated
        public static final int Cpt = CPT;
        @Deprecated
        public static final int TruthTable = TRUTH_TABLE;
        @Deprecated
        public static final int List = DECISION;
        @Deprecated
        public static final int Table = UTILITY;
        @Deprecated
        public static final int Mau = MAU;
        @Deprecated
        public static final int NoisyMax = NOISY_MAX;
        @Deprecated
        public static final int NoisyAdder = NOISY_ADDER;
        @Deprecated
        public static final int Equation = EQUATION;
        @Deprecated
        public static final int DeMorgan = DEMORGAN;
    }

    // type of arc between two DeMorgan nodes	
    public static class DeMorganParentType {
        ...
        @Deprecated
        public static final int Inhibitor = INHIBITOR;
        @Deprecated
        public static final int Requirement = REQUIREMENT;
        @Deprecated
        public static final int Cause = CAUSE;
        @Deprecated
        public static final int Barrier = BARRIER;
    }
	
    // Temporal (DBN) node types
    public static class NodeTemporalType {
        ...
        @Deprecated
        public static final int Contemporal = CONTEMPORAL;
        @Deprecated
        public static final int Anchor = ANCHOR;
        @Deprecated
        public static final int Terminal = TERMINAL;
        @Deprecated
        public static final int Plate = PLATE;
    }
	
    // Diagnostic types
    public static class NodeDiagType {
        public static final int FAULT = 0;
        public static final int OBSERVATION = 1;
        public static final int AUXILIARY = 2;

        @Deprecated
        public static final int Fault = FAULT;
        @Deprecated
        public static final int Observation = OBSERVATION;
        @Deprecated
        public static final int Auxiliary = AUXILIARY;
    }
	
    public native void readFile(String fileName);
    public native void writeFile(String fileName);
	
    public native void readString(String xdslContent);
    public native String writeString();
    ...
    public final native String getLibraryBuild();
    ...
    public native boolean isRelevanceEnabled();
    public native void setRelevanceEnabled(boolean enable);
	
    public native AnnealedMapResults annealedMap(int[] mapNodes, AnnealedMapTuning tuning);
    public native AnnealedMapResults annealedMap(String[] mapNodes, AnnealedMapTuning tuning);

    public native int getSampleCount();
    public native void setSampleCount(int sampleCount);

	public native boolean isOutlierRejectionEnabled();
	public native void setOutlierRejectionEnabled(boolean enabled);

	public native int getDiscretizationSampleCount();
	public native void setDiscretizationSampleCount(int discretizationSampleCount);

	public native boolean isZeroAvoidanceEnabled();
	public native void setZeroAvoidanceEnabled(boolean enable);
    ...
    public native void insertOutcome(int nodeHandle, int position, String outcomeId);
    public native void insertOutcome(String nodeId, int position, String outcomeId);
    ...
    public native void setNodeEquationBounds(int nodeHandle, double lo, double hi);
	...
	public native void setNodeEquationDiscretization(int nodeHandle, DiscretizationInterval[] intervals);
	public native void setNodeEquationDiscretization(String nodeId, DiscretizationInterval[] intervals);

	public native DiscretizationInterval[] getNodeEquationDiscretization(int nodeHandle);
	public native DiscretizationInterval[] getNodeEquationDiscretization(String nodeId);
	...
	public native boolean isValueDiscretized(int nodeHandle);
	public native boolean isValueDiscretized(String nodeId);

	public native double[] getNodeSampleStats(int nodeHandle);
	public native double[] getNodeSampleStats(String nodeId);
    ...
    public native void setNoisyParentStrengths(int nodeHandle, int parentIndex, int[] strengths);
    public native void setNoisyParentStrengths(String nodeId, int parentIndex, int[] strengths);
    public native void setNoisyParentStrengths(int nodeHandle, String parentId, int[] strengths);
    public native void setNoisyParentStrengths(String nodeId, String parentId, int[] strengths);
    ...
    public native boolean isNoisySynchronized(int nodeHandle);
    public native boolean isNoisySynchronized(String nodeId);

    public native boolean isNoisyExpanded(int nodeHandle);
    public native boolean isNoisyExpanded(String nodeId);

    public native void setNoisySynchronized(int nodeHandle, boolean enable);
    public native void setNoisySynchronized(String nodeId, boolean enable);

    public native double[] getNoisyExpandedDefinition(int nodeHandle);
    public native double[] getNoisyExpandedDefinition(String nodeId);
    ...
    public native void setDeMorganParentType(int nodeHandle, int parentIndex, int parentType);
    public native void setDeMorganParentType(String nodeId, int parentIndex, int parentType);
    public native void setDeMorganParentType(int nodeHandle, String parentId, int parentType);
    public native void setDeMorganParentType(String nodeId, String parentId, int parentType);
    ...
    public native void setDeMorganParentWeight(int nodeHandle, int parentIndex, double parentWeight);
    public native void setDeMorganParentWeight(String nodeId, int parentIndex, double parentWeight);
    public native void setDeMorganParentWeight(int nodeHandle, String parentId, double parentWeight);
    public native void setDeMorganParentWeight(String nodeId, String parentId, double parentWeight);
    ...
    public native void setVirtualEvidence(int nodeHandle, double []evidence);
    public native void setVirtualEvidence(String nodeId, double []evidence);
    ...
    public native double[] getVirtualEvidence(int nodeHandle);
    public native double[] getVirtualEvidence(String nodeId);
    ...
    public native boolean isVirtualEvidence(int nodeHandle);
    public native boolean isVirtualEvidence(String nodeId);
    ...
    public native void addTemporalArc(int parentHandle, int childHandle, int order);
    public native void addTemporalArc(String parentId, String childId, int order);
	
    public native void deleteTemporalArc(int parentHandle, int childHandle, int order);
    public native void deleteTemporalArc(String parentId, String childId, int order);
	
    public native boolean temporalArcExists(int parentHandle, int childHandle, int order);
    public native boolean temporalArcExists(String parentId, String childId, int order);
    ...
    public native void setTemporalEvidence(int nodeHandle, int slice, int outcomeIndex);
    public native void setTemporalEvidence(String nodeId, int slice, int outcomeIndex);
    public native void setTemporalEvidence(int nodeHandle, int slice, String outcomeId);
    public native void setTemporalEvidence(String nodeId, int slice, String outcomeId);
    ...
    public native void setNodeTemporalDefinition(int nodeHandle, int order, double[] definition);
    public native void setNodeTemporalDefinition(String nodeId, int order, double[] definition);

    public native int[][] getNoisyTemporalParentStrengths(int nodeHandle, int order);
    public native int[][] getNoisyTemporalParentStrengths(String nodeId, int order);
	
    public native void setNoisyTemporalParentStrengths(int nodeHandle, int order, int[][] strengths);
    public native void setNoisyTemporalParentStrengths(String nodeId, int order, int[][] strengths);

    // --- graphical appearance ---
    public native void setNodePosition(int nodeHandle, int x, int y, int width, int height);
    public native void setNodePosition(String nodeId, int x, int y, int width, int height);
    public void setNodePosition(int nodeHandle, java.awt.Rectangle rect) { setNodePosition(nodeHandle, rect.x, rect.y, rect.width, rect.height); }
    public void setNodePosition(String nodeId, java.awt.Rectangle rect) { setNodePosition(nodeId, rect.x, rect.y, rect.width, rect.height); }
	
    public native java.awt.Rectangle getNodePosition(int nodeHandle);
    public native java.awt.Rectangle getNodePosition(String nodeId);
	
    public native void setNodeBgColor(int nodeHandle, java.awt.Color color);
    public native void setNodeBgColor(String nodeId, java.awt.Color color);
    public native java.awt.Color getNodeBgColor(int nodeHandle);
    public native java.awt.Color getNodeBgColor(String nodeId);
	
    public native void setNodeTextColor(int nodeHandle, java.awt.Color color);
    public native void setNodeTextColor(String nodeId, java.awt.Color color);
    public native java.awt.Color getNodeTextColor(int nodeHandle);
    public native java.awt.Color getNodeTextColor(String nodeId);
	
    public native void setNodeBorderColor(int nodeHandle, java.awt.Color color);
    public native void setNodeBorderColor(String nodeId, java.awt.Color color);
    public native java.awt.Color getNodeBorderColor(int nodeHandle);
    public native java.awt.Color getNodeBorderColor(String nodeId);
    ...
    public native java.awt.Rectangle getSubmodelPosition(int submodelHandle);
    public native java.awt.Rectangle getSubmodelPosition(String submodelID);
    public native void setSubmodelPosition(int submodelHandle, int x, int y, int width, int height);
    public native void setSubmodelPosition(String submodelId, int x, int y, int width, int height);
    public void setSubmodelPosition(int submodelHandle, java.awt.Rectangle rect) { setSubmodelPosition(submodelHandle, rect.x, rect.y, rect.width, rect.height); }
    public void setSubmodelPosition(String submodelId, java.awt.Rectangle rect) { setSubmodelPosition(submodelId, rect.x, rect.y, rect.width, rect.height); }
    ...
    public native void setOutcomeFix(int nodeHandle, int outcomeIndex, String treatment);
    public native void setOutcomeFix(String nodeId, int outcomeIndex, String treatment);
    public native void setOutcomeFix(int nodeHandle, String outcomeId, String treatment);
    public native void setOutcomeFix(String nodeId, String outcomeId, String treatment);
    ...
    public native void setOutcomeDescription(int nodeHandle, int outcomeIndex, String description);
    public native void setOutcomeDescription(String nodeId, int outcomeIndex, String description);
    public native void setOutcomeDescription(int nodeHandle, String outcomeId, String description);
    public native void setOutcomeDescription(String nodeId, String outcomeId, String description);
    ...
    public native boolean setOutcomeLabel(int nodeHandle, int outcomeIndex, String label);
    public native boolean setOutcomeLabel(String nodeId, int outcomeIndex, String label);
    public native boolean setOutcomeLabel(int nodeHandle, String outcomeId, String label);
    public native boolean setOutcomeLabel(String nodeId, String outcomeId, String label);
    ...
    public native void setFaultOutcome(int nodeHandle, int outcomeIndex, boolean fault);
    public native void setFaultOutcome(String nodeId, int outcomeIndex, boolean fault);
    public native void setFaultOutcome(int nodeHandle, String outcomeId, boolean fault);
    public native void setFaultOutcome(String nodeId, String outcomeId, boolean fault);
    ...
    public native void setNodeUserProperties(int nodeHandle, UserProperty[] properties);
    public native void setNodeUserProperties(String nodeId, UserProperty[] properties);
    ...
    public native void setNodeDocumentation(int nodeHandle, DocItemInfo[] documentation);
    public native void setNodeDocumentation(String nodeId, DocItemInfo[] documentation);

    public native DocItemInfo[] getOutcomeDocumentation(int nodeHandle, int outcomeIndex);
    public native DocItemInfo[] getOutcomeDocumentation(String nodeId, int outcomeIndex);
    public native DocItemInfo[] getOutcomeDocumentation(String nodeId, String outcomeId);
    public native DocItemInfo[] getOutcomeDocumentation(int nodeHandle, String outcomeId);
	
    public native void setOutcomeDocumentation(int nodeHandle, int outcomeIndex, DocItemInfo[] documentation);
    public native void setOutcomeDocumentation(int nodeHandle, String outcomeId, DocItemInfo[] documentation);
    public native void setOutcomeDocumentation(String nodeId, String outcomeId, DocItemInfo[] documentation);
    public native void setOutcomeDocumentation(String nodeId, int outcomeIndex, DocItemInfo[] documentation);
    
    protected native long createNative(Object param);
    protected native void deleteNative(long nativePtr);

    // --- Clone the network object ---
    private native Network cloneme();
    public Object clone() throws CloneNotSupportedException {
        return cloneme();
    }
	
    public native void distributedHelperEM(double [] counts);
}
